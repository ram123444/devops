...
#tcin-infosec-dev resource block

resource "aws_organizations_account" "tcin-infosec-dev" {
  name              = var.account_name_tcin-infosec-dev
  email             = var.mail_id_tcin-infosec-dev
  parent_id         = var.OU_id_tcin-infosec-dev
  role_name         = "OrganizationAccountAccessRole"
  close_on_deletion = "true"
}

output "accounetid_tcin-infosec-dev" {
  value = aws_organizations_account.tcin-infosec-dev.id
}
...
#tcin-llm-research-dev resource block

resource "aws_organizations_account" "tcin-llm-research-dev" {
  name      = var.account_name_tcin-llm-research-dev
  email     = var.mail_id_tcin-llm-research-dev
  parent_id = var.OU_id_tcin-llm-research-dev
  role_name = "OrganizationAccountAccessRole"
  close_on_deletion = "true"
}

output "accounetid_tcin-llm-research-dev" {
  value = aws_organizations_account.tcin-llm-research-dev.id
}